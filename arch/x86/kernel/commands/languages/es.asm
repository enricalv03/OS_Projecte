...
global cmd_panic_es
global cmd_spawn_es
global cmd_whoami_es
global cmd_pwd_es
global cmd_touch_es
global cmd_sysinfo_es
global cmd_hostname_es
global cmd_head_es
global cmd_wc_es
global cmd_ring3_es
...
cmd_panic_es:    db 'panic', 0
cmd_spawn_es:    db 'spawn', 0
cmd_whoami_es:   db 'quiensoy', 0
cmd_pwd_es:      db 'ruta', 0
cmd_touch_es:    db 'tocar', 0
cmd_sysinfo_es:  db 'infosistema', 0
cmd_hostname_es: db 'host', 0
cmd_head_es:     db 'cabeza', 0
cmd_wc_es:       db 'contar', 0
cmd_ring3_es:    db 'ring3', 0
...
global become_prompt_es, become_wrong_pw_es
...
global whoami_root_es, whoami_user_es
global touch_ok_es, touch_usage_es, touch_fail_es
global sysinfo_arch_es, sysinfo_mem_es, sysinfo_proc_es, sysinfo_fs_es, sysinfo_lang_es
global hostname_msg_es
global head_usage_es
global wc_lines_es, wc_usage_es

unknown_cmd_es:      db 'Comando desconocido', 0
help_msg_es:         db 'listar  ver  escribir  creadir  copiar  mover  borrar  buscar  ir  limpiar  eco', 10, 'quiensoy  ruta  tocar  sysinfo  cabeza  contar  hostname', 10, 'Escribe "ayuda all" para ver todos los comandos', 0
help_all_es:
  db '--- Archivos ---', 0
  ...
  db '--- Info ---', 0
  db '  quiensoy               Muestra usuario actual', 0
  db '  ruta                   Muestra directorio actual', 0
  db '  hostname               Muestra nombre del sistema', 0
  db '  sysinfo                Informacion del sistema', 0
  db '  cabeza <archivo>       Muestra primeras 5 lineas', 0
  db '  contar <archivo>       Cuenta lineas y bytes', 0
  db '  tocar <archivo>        Crea archivo vacio', 0
  db '--- Usuario ---', 0
  db '  cambiarusuario admin|user  Cambia usuario (atajo: cu)', 0
  db '  idioma [en|ca|es]      Cambia idioma (lang/language)', 0
  db '--- Avanzado ---', 0
  db '  ring3                  Probar modo usuario ring-3 (sin retorno)', 0
  db 0
...
become_prompt_es:     db 'Contrasena para admin: ', 0
become_wrong_pw_es:   db 'Contrasena incorrecta', 0
...
whoami_root_es:      db 'admin (root)', 0
whoami_user_es:      db 'usuario', 0
touch_ok_es:         db 'Archivo creado (vacio)', 0
touch_usage_es:      db 'Uso: tocar <archivo>', 0
touch_fail_es:       db 'No se puede crear el archivo', 0
sysinfo_arch_es:     db 'Arquitectura: x86 (i686)', 0
sysinfo_mem_es:      db 'Paginas libres: ', 0
sysinfo_proc_es:     db 'Procesos activos: ', 0
sysinfo_fs_es:       db 'Sistema de archivos: RAMFS', 0
sysinfo_lang_es:     db 'Idioma: ', 0
hostname_msg_es:     db 'MyOS', 0
head_usage_es:       db 'Uso: cabeza <archivo>', 0
wc_lines_es:         db ' lineas, ', 0
wc_usage_es:         db 'Uso: contar <archivo>', 0

global ring3_msg_es
ring3_msg_es:        db 'Cambiando a modo usuario ring-3...', 0
