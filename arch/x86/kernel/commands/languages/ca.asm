...
global cmd_panic_ca
global cmd_spawn_ca
global cmd_whoami_ca
global cmd_pwd_ca
global cmd_touch_ca
global cmd_sysinfo_ca
global cmd_hostname_ca
global cmd_head_ca
global cmd_wc_ca
global cmd_ring3_ca
...
cmd_panic_ca:    db 'panic', 0
cmd_spawn_ca:    db 'spawn', 0
cmd_whoami_ca:   db 'quiso', 0
cmd_pwd_ca:      db 'cami', 0
cmd_touch_ca:    db 'toca', 0
cmd_sysinfo_ca:  db 'sysinfo', 0
cmd_hostname_ca: db 'hostname', 0
cmd_head_ca:     db 'cap', 0
cmd_wc_ca:       db 'compta', 0
cmd_ring3_ca:    db 'ring3', 0
...
global become_prompt_ca, become_wrong_pw_ca
...
global whoami_root_ca, whoami_user_ca
global touch_ok_ca, touch_usage_ca, touch_fail_ca
global sysinfo_arch_ca, sysinfo_mem_ca, sysinfo_proc_ca, sysinfo_fs_ca, sysinfo_lang_ca
global hostname_msg_ca
global head_usage_ca
global wc_lines_ca, wc_usage_ca

unknown_cmd_ca:      db 'Comanda desconeguda', 0
help_msg_ca:         db 'llista  mostra  escriu  creadir  copia  mou  esborrar  cerca  ves  neteja  eco', 10, 'quiso  cami  toca  sysinfo  cap  compta  hostname', 10, 'Escriu "ajuda all" per veure totes les comandes', 0
help_all_ca:
  db '--- Fitxers ---', 0
  ...
  db '--- Info ---', 0
  db '  quisoc                  Mostra usuari actual', 0
  db '  cami                   Mostra directori de treball', 0
  db '  nomhost               Mostra nom del sistema', 0
  db '  infosistema                Informacio del sistema', 0
  db '  cap <fitxer>           Mostra primeres 5 linies', 0
  db '  compta <fitxer>        Compta linies i bytes', 0
  db '  crea <fitxer>          Crea fitxer buit', 0
  db '--- Usuari ---', 0
  db '  canviausuari admin|user  Canvia usuari (drecera: cu)', 0
  db '  idioma [en|ca|es]      Canvia idioma (lang/language)', 0
  db '--- Avancat ---', 0
  db '  ring3                  Prova mode usuari ring-3 (sense retorn)', 0
  db 0
...
become_prompt_ca:     db 'Contrasenya per admin: ', 0
become_wrong_pw_ca:   db 'Contrasenya incorrecta', 0
...
whoami_root_ca:      db 'admin (root)', 0
whoami_user_ca:      db 'usuari', 0
touch_ok_ca:         db 'Fitxer creat (buit)', 0
touch_usage_ca:      db 'Us: toca <fitxer>', 0
touch_fail_ca:       db 'No es pot crear el fitxer', 0
sysinfo_arch_ca:     db 'Arquitectura: x86 (i686)', 0
sysinfo_mem_ca:      db 'Pagines lliures: ', 0
sysinfo_proc_ca:     db 'Processos actius: ', 0
sysinfo_fs_ca:       db 'Sistema de fitxers: RAMFS', 0
sysinfo_lang_ca:     db 'Idioma: ', 0
hostname_msg_ca:     db 'MyOS', 0
head_usage_ca:       db 'Us: cap <fitxer>', 0
wc_lines_ca:         db ' linies, ', 0
wc_usage_ca:         db 'Us: compta <fitxer>', 0

global ring3_msg_ca
ring3_msg_ca:        db 'Canviant a mode usuari ring-3...', 0
